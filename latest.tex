...
\begin{document}
% ABSOLUTE PATH TO FILE /math/home/artin/H/AG/Ryan/18.721

% LIST OF OMMITTED REFERENCES: 191 938 2642 3125 2790
...
fairly clear.  It can be justified formally in terms of {\it
  dimension}, which will be discussed in Chapter 
  %\ref{zarstr}
  .\qed
...
\label{goober0}
\Marginnote{goober0}
\includegraphics[width=5.0cm]{./images/Cusp/Cusp.pdf}
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober1}
\Marginnote{goober1}
\includegraphics[width=5.0cm]{./images/Intersecting/Intersecting.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober2}
\Marginnote{goober2}
\includegraphics[width=5.0cm]{./images/Node/Node.pdf}
\includegraphics[width=3cm]{./images/Cusp/Cusp.pdf}
\raisebox{1.25cm}{
\includegraphics[width=5.0cm]{./images/Intersecting/Circle-Intersecting.pdf}
}
\begin{thm}
  \parbox{.8\linewidth}{\center{
  A node with equation $y^2 = x^3 + x$, a cusp with equation $y^2 = x^3$, and a circle $x^2 + y^2 = 1$ 
  intersecting the lines $y = 0,1$.
  }}
\end{thm}
\end{figure}
...
\label{goober5}
\Marginnote{goober5}
\includegraphics[width=5.0cm]{./images/Projecting/Projecting.png} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober6}
\Marginnote{goober6}
\includegraphics[width=5.0cm]{./images/Wolfram/asymptote.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober7}
\Marginnote{goober7}
\includegraphics[width=5.0cm]{./images/Wolfram/capricornoid.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
...
\label{goober8}
\Marginnote{goober8}
\includegraphics[width=5.0cm]{./images/Wolfram/cubic.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober9}
\Marginnote{goober9}
The image ``double-torus.pdf'' was missing.
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
 \end{figure}
...
\label{goober10}
\Marginnote{goober10}
\includegraphics[width=5.0cm]{./images/Wolfram/parametrized_cusp.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\Marginnote{goober11}
\label{goober11}
\includegraphics[width=7.0cm, height=5cm]{./images/Wolfram/ruled_hyperboloid.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober12}
\Marginnote{goober12}
The image ``trott-curve.pdf'' was missing.
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober13}
\Marginnote{goober13}
\includegraphics[width=5.0cm]{./images/Wolfram/trott_curve_tangents.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober14}
\Marginnote{goober14}
\includegraphics[width=5.0cm]{./images/intersxon_multi/intersxon_multi.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober15}
\Marginnote{goober15}
\includegraphics[width=15.0cm]{./images/my_figure/my_figure.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober16}
\Marginnote{goober16}
\includegraphics[width=10.0cm]{./images/proj_comp/proj_comp.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober17}
\Marginnote{goober17}
\includegraphics[width=8cm]{./images/projecting-node/project-node.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober18}
\Marginnote{goober18}
\includegraphics[width=5.0cm]{./images/tacnode/tacnode.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober20}
\Marginnote{goober20}
\includegraphics[width=8.0cm]{./images/zariski_closed/zariski_closed.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober21}
\Marginnote{goober21}
\includegraphics[width=8.0cm]{./images/double_torus/double_torus.pdf} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober22}
\Marginnote{goober22}
\includegraphics[width=8.0cm]{./images/durer/durer_cropped.png} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
...
\label{goober23}
\Marginnote{goober23}
\includegraphics[width=10.0cm]{./images/duality/duality.png} \\
\begin{thm}
  \centerline{\vspace{-12pt}This is a nice caption}
\end{thm}
\end{figure}
